...
export default function SalesReports() {
  ...
  const tabs = [
    { id: 'reps', label: 'حسب مسؤل المبيعات', icon: Users },
      ...
      {activeTab === 'reps' && (
        <div style={card}>
          <div style={{ padding: '14px 20px', borderBottom: '1px solid #f0f4fa', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <h3 style={{ fontSize: 14, fontWeight: 700, color: '#0f172a' }}>أداء مسؤل المبيعاتين</h3>
          </div>
          <div className="m-table-scroll">
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13, minWidth: 560 }}>
              <thead>
                <tr style={{ background: '#f8fafc' }}>
                  {['مسؤل المبيعات', 'عدد الطلبات', 'الإيرادات', 'صافي الربح', 'هامش الربح', 'معدل الإغلاق'].map((h, i) => (
