...
const GUIDES = {
  ...
  team_leader: {
    ...
    bg: '#ecfeff',
    border: '#a5f3fc',
    intro: 'مهمتك مراجعة طلبات مسؤل المبيعاتين والموافقة عليها أو رفضها قبل ما تعدي للأدمن.',
    steps: [
      ...
      { title: 'وافق أو ارفض', desc: 'موافقة: الطلب بيروح للأدمن / رفض: مسؤل المبيعاتبيشوفه ويقدر يعدل ويبعت تاني' },
    ...
    statuses: [
      ...
      { label: 'مرفوض', color: '#e11d48', desc: 'رفضت — مسؤل المبيعاتيقدر يعدّل ويبعت تاني' },
    ],
    warnings: [
      'الطلبات المرفوضة بترجع للمندوب ويقدر يعدّل ويبعتها تاني',
      'لما مسؤل المبيعاتيعدّل المرفوض، بيرجع تاني لـ "بانتظار الموافقة"',
  ...
  admin: {
    ...
    warnings: [
      ...
      'الفاتورة الضريبية محتاج رقم ضريبي — تأكد مسؤل المبيعاتحطّه',
