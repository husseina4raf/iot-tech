    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <div style={card}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
          ...
          <FInput label="رابط الموقع على الخريطة" error={errors.locationLink} style={{ gridColumn: '1/-1' }} placeholder="https://maps.google.com/..." value={form.locationLink} onChange={e => upd('locationLink', e.target.value)} dir="ltr" />
        </div>
      </div>
