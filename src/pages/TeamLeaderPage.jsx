...
import { Clock, CheckCircle, XCircle, FileText, ChevronDown, User, Package, Phone, MapPin, CreditCard, Calendar } from 'lucide-react'
...
export default function TeamLeaderPage() {
  ...
  const { orders, approveOrder, rejectOrder, updateOrderStatus } = useOrders()
  const { user } = useAuth()
